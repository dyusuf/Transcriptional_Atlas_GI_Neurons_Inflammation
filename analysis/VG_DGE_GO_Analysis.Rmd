...
vg.nippo <- read_excel("../data/processed/VG_DESeq2_Nippo.xlsx")
vg.dss <- read_excel("../data/processed/VG_DESeq2_DSS.xlsx")
vg.th17 <- read_excel("../data/processed/VG_DESeq2_Th17.xlsx")
...
vg.nippo <- transform(vg.nippo, pvalue=sapply(pvalue, formatC, format = "e", digits=3))
vg.nippo <- transform(vg.nippo, padj=sapply(padj, formatC, format = "e", digits=3))
vg.nippo <-vg.nippo  %>% mutate_at(vars("BaseMean", "Log2FC", "StdErr", "Wald-Stats"), funs(round(., 3)))
...
vg.dss <- transform(vg.dss, pvalue=sapply(pvalue, formatC, format = "e", digits=3))
vg.dss <- transform(vg.dss, padj=sapply(padj, formatC, format = "e", digits=3))
vg.dss <-vg.dss  %>% mutate_at(vars("BaseMean", "Log2FC", "StdErr", "Wald-Stats"), funs(round(., 3)))
...
vg.th17 <- transform(vg.th17, pvalue=sapply(pvalue, formatC, format = "e", digits=3))
vg.th17 <- transform(vg.th17, padj=sapply(padj, formatC, format = "e", digits=3))
vg.th17 <-vg.th17  %>% mutate_at(vars("BaseMean", "Log2FC", "StdErr", "Wald-Stats"), funs(round(., 3)))
...
vg.nippo<- vg.nippo[vg.nippo$BaseMean > 50, ]
...
multi_gp_vg_nippo = gost(list("up-regulated" = up.genes.ordered$gene_name,
...
## DSS
vg.dss <- vg.dss[vg.dss$BaseMean > 50, ]
...
multi_gp_vg_dss = gost(list("up-regulated" = up.genes.ordered$gene_name,
                     "down-regulated" = dn.genes.ordered$gene_name),organism = "mmusculus", ordered_query = TRUE)
...
vg.th17<- vg.th17[vg.th17$BaseMean > 50, ]
...
multi_gp_vg_th17 = gost(list("up-regulated" = up.genes.ordered$gene_name,
                     "down-regulated" = dn.genes.ordered$gene_name),organism = "mmusculus", ordered_query = TRUE)
