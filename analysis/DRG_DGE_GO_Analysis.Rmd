...
drg.nippo1 <- transform(drg.nippo, pvalue=sapply(pval, formatC, format = "e", digits=3))
drg.nippo1 <- transform(drg.nippo1, padj=sapply(padj, formatC, format = "e", digits=3))
drg.nippo1 <- drg.nippo1  %>% mutate_at(vars("BaseMean", "Log2FC", "StdErr", "WaldStat"), funs(round(., 3)))
...
drg.dss1 <- transform(drg.dss, pvalue=sapply(pval, formatC, format = "e", digits=3))
drg.dss1 <- transform(drg.dss1, padj=sapply(padj, formatC, format = "e", digits=3))
drg.dss1 <-drg.dss1  %>% mutate_at(vars("BaseMean", "Log2FC", "StdErr", "WaldStat"), funs(round(., 3)))
...
drg.th171 <- transform(drg.th17, pvalue=sapply(pval, formatC, format = "e", digits=3))
drg.th171 <- transform(drg.th171, padj=sapply(padj, formatC, format = "e", digits=3))
drg.th171 <-drg.th17  %>% mutate_at(vars("BaseMean", "Log2FC", "StdErr", "WaldStat"), funs(round(., 3)))
...
multi_gp_drg_nippo = gost(list("up-regulated" = up.genes.ordered$GeneName,
...
multi_gp_drg_dss = gost(list("up-regulated" = up.genes.ordered$GeneName,
                     "down-regulated" = dn.genes.ordered$GeneName),organism = "mmusculus", ordered_query = TRUE)
...
multi_gp_drg_th17 = gost(list("up-regulated" = up.genes.ordered$GeneName,
                     "down-regulated" = dn.genes.ordered$GeneName),organism = "mmusculus", ordered_query = TRUE)
